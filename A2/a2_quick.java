...
public class a2_quick {
   ...
   private static void get_values(int[] a, String fn, int n) {
   ...
   private static void quicksort(int[] a, int left, int right, int which) {
      int px;
      if (which == 1) px = p_index1(a, left, right);
      else px = p_index2(a, left, right);
   ...
   private static int p_index1(int[] a, int left, int right) {
   ...
   private static void test_algorithms(int a[], int n, String fn)
         throws IOException {
      long start;
